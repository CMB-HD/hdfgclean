...
epilog = "See the `reproduce_10x10.ipynb` notebook for more information."
...
if args.test:
    ...
    t = time.time() # time it
    fgcleanlib.run_hdfgclean(take_power=args.spectra, match_to_true_catalogs=args.match, make_plots=args.plots, use_fig_settings=True)
